...
// This is an example program taken from https://github.com/dimforge/kiss3d.
// It should create a scene that has a "red, rotating cube with a light attached to the camera".
